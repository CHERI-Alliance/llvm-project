...
for.inc.outer:
; GEN: for.inc.outer:
; NOTENTRY: call void @llvm.instrprof.increment.p0(ptr @__profn_test_nested_for, i64 {{[0-9]+}}, i32 3, i32 1)
; ENTRY: call void @llvm.instrprof.increment.p0(ptr @__profn_test_nested_for, i64 {{[0-9]+}}, i32 3, i32 2)
